        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-10 mb-16">
          <div className="col-span-2 lg:col-span-1">
            ...
            <div className="flex items-center gap-4 text-text-muted">
              <a href="https://github.com/onyx" aria-label="GitHub" className="hover:text-white transition-colors"><Github size={20} /></a>
              <a href="https://twitter.com/onyx" aria-label="Twitter" className="hover:text-white transition-colors"><Twitter size={20} /></a>
              <a href="https://linkedin.com/company/onyx" aria-label="LinkedIn" className="hover:text-white transition-colors"><Linkedin size={20} /></a>
            </div>
          </div>
